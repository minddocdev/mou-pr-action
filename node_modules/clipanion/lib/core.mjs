    ...
    compile() {
        ...
        for (const path of paths) {
            ...
            if (this.arity.leading.length > 0) {
                ...
                registerStatic(machine, lastPathNode, SpecialToken.EndOfPartialInput, NodeType.SuccessNode, [`setPartialIndex`, this.cliIndex]);
            }
            ...
            for (let t = 0; t < this.arity.leading.length; ++t) {
                ...
                if (this.arity.trailing.length > 0 || t + 1 !== this.arity.leading.length) {
                    ...
                    registerStatic(machine, nextLeadingNode, SpecialToken.EndOfPartialInput, NodeType.SuccessNode, [`setPartialIndex`, this.cliIndex]);
                }
            ...
            if (this.arity.trailing.length > 0) {
                ...
                registerStatic(machine, lastExtraNode, SpecialToken.EndOfPartialInput, NodeType.SuccessNode, [`setPartialIndex`, this.cliIndex]);
            }
            ...
            for (let t = 0; t < this.arity.trailing.length; ++t) {
                ...
                if (t + 1 < this.arity.trailing.length) {
                    ...
                    registerStatic(machine, nextTrailingNode, SpecialToken.EndOfPartialInput, NodeType.SuccessNode, [`setPartialIndex`, this.cliIndex]);
                }
